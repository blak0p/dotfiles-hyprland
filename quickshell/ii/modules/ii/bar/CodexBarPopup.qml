...
/*
 * CodexBarPopup — Detailed usage popup for Codex/OpenAI.
 *
 * Extends StyledPopup (LazyLoader + PanelWindow) and renders all the
 * usage sections: Weekly, Session, Tertiary, Reset Credits, Code Review
 * Credits, OpenAI Status, Data Confidence, and error state.
 *
 * Activated by CodexBarWidget via a fakeHover trick.
 */
...
StyledPopup {
    ...
    // Track popup lifecycle for the service timer
